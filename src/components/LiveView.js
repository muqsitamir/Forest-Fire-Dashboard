  ...
  return (
    <div  >
      ...
      <li className="nav-item">
        <a
          className={activeTab === 'camera' ? 'nav-link active' : 'nav-link'}
          onClick={() =>  {setView("camera"); handleTabClick('camera')}}
        >
          Camera
        </a>
      </li>
      <li>
        <a
          ...
          onClick={() => {setView("map"); handleTabClick('map')}}
        >
          Map
        </a>
      </li>
      <li>
        <a
          className={activeTab === 'stats' ? 'nav-link active' : 'nav-link'}
          onClick={() => {setView("stats"); handleTabClick('stats')}}
        >
          Weather Graph
        </a>
      </li>
          ...
          <div className='row' style={{ height: "50%" }}>
            <div className='col-md-4 d-flex justify-content-center'>
              <div className=' row mx-2 px-2 d-flex justify-content-center' style={{ backgroundColor: "white" }}>
                  ...
                  <center style={{marginTop:'10px',height:'20%'}}>  
                    ...
                    <div style={{
                     ...
                     flexDirection:'row',
                     alignItems:'center'
                     ,justifyContent:'center',width:'100%',marginBottom:'0px'}}> 
                     <p style={{fontSize:'14px'}}>{date} {currentTime} </p></div>
                     {air_humidity&& air_temp&&(
                      <div style={{
                        ...
                        <Tooltip title="Air Temperature" style={{marginTop:'4px'}}>
                              <p style={{marginBottom:'0px'}}><IconButton style={{ color: '#868B94' ,padding:'0px'  }}>
                              <Avatar src={airtemp} style={{ borderRadius: "0px", width: "30px", height: "30px" }} />
                              </IconButton>
                             ...
                             <IconButton style={{ color: '#868B94' ,padding:'0px' ,marginBottom:'0px' }}>
                              <Avatar src={airhumidity} style={{ borderRadius: "0px", width: "25px", height: "25px" }} /></IconButton>
                                {air_humidity}%</p>
                                </Tooltip></div>
                     )}
                  ...
                  <center style={{height:'20px'}}>  <p className='lead' style={{display: 'flex', alignItems: 'flex-end' ,justifyContent:'center',fontWeight:'700'}}>PTZ Controls </p>
                  </center>
            ...
            <div className='col-md-8' style={{ backgroundColor: '#eeee',    paddingBottom: "20px"}}>
              <div className='mb-3 d-flex justify-content-center' style={{height:'50%',width:"100%"}}>
                ...
                :view === 'stats' ? (<TemperatureHumidityGraph id={id} />)
                 :( <MiniMap camId={id} />)
                }
              </div>
            </div>
