...
export const getEvents =
  (page, filterApplied,rowsPerPage,camId) =>
  (dispatch, getState) => {
    ...
    axios
      .get(
        `${backend_url}/core/api/event/?datetime_after=${result.start}&datetime_before=${result.end}&cameras=${camId}&species=${species_selected}&page=${page}&page_size=${rowsPerPage}`,
        config
      )
      .then((res) => {
...
export const { setEvents, resetEvents } = LiveSlice.actions;
