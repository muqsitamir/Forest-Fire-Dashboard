...
const LiveChart = ({ cameraId, cameraName }) => {
  ...
  return (
    <div style={{overflowY:'scroll',overflowX:'hidden',width:'100%', height:'37vh',display:'flex',justifyContent:'space-evenly',background:'#eeee',borderRadius:'25px',border:'5px solid #eee'}}>
